...
<head>
    ...
    <title>Paletas de Colores de Arte</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <img src="monet-pond.jpg" alt="Monet Waterlily Pond">
        <table>
            <tr>
    ...
    <div class="container">
        <img src="monet-cliffs.jpg" alt="Monet Cliffs of Aval">
        <table>
            <tr>
    ...
    <div class="container">
        <img src="dress-detail.jpg" alt="Painting Dress Detail">
        <table>
            <tr>
